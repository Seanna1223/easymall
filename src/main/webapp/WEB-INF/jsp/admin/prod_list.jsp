...
<html>
	...
	<table width="799" height="80" border="1" cellpadding="0" cellspacing="0" bordercolor="#d8d8d8">
				...
				<tr>
					...
					<td><a href="${ pageContext.request.contextPath }/admin/modifyprod?id=${prod.id}">修改</a></td>
					<td><a href="${ pageContext.request.contextPath }/admin/OnSale?id=${prod.id}">上架</a>
					<br/>
					<a href="${ pageContext.request.contextPath }/admin/OffSale?id=${prod.id}">下架</td>
					<td></a></td>
