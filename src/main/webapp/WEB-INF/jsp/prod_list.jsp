...
<body>
	...
	<div id="content">
		<div id="search_div">
			<form method="post" action="${ pageContext.request.contextPath }/prodlist" method="post">
				...
				<span class="input_span">商品价格区间：<input type="text" name="minprice" value="${param.minprice}"/> 
		...
		<div id="prod_content">
			...
			<div class="prod_div">
				...
				<div id="prod_name_div">
					<a href="${ pageContext.request.contextPath}/prodInfo?pid=${prod.id}">
						${prod.name }
					</a>
				</div>
