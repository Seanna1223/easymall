...
<html>
	<head>
		...
		<title>欢迎光临EasyMall 陈晓琪20192031010</title>
	</head>
	<body>
	<!-- 将头部(_head.jsp)包含进来 -->
	<jsp:include page="/WEB-INF/jsp/_head.jsp"/>
		<div id="index">
			...
			<div id="line2">
				<img id="line2_1" src="${ pageContext.request.contextPath }/img/index/b.jpg"/>
				<img id="line2_2" src="${ pageContext.request.contextPath }/img/index/a.jpg"/>
				<img id="line2_3" src="${ pageContext.request.contextPath }/img/index/adv_l1.jpg"/>
			</div>
			<div id="line3">
				<img id="line3_1" src="${ pageContext.request.contextPath }/img/index/c.jpg"/>
				<img id="line3_2" src="${ pageContext.request.contextPath }/img/index/d.jpg"/>
				<div id="line3_right">
