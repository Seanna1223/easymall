...
public class OrderController extends BaseController {
	...
	public String payorder(String id, Integer state, Model model) {
		orderService.payorder(id);
		return "redirect:/order/showorder";
	}

	@RequestMapping("/deliever")
	public String deliever(String id, Model model) {
		orderService.deliever(id);
		return "redirect:/admin/allorder";
	}

	@RequestMapping("/received")
	public String received(String id, Model model) {
